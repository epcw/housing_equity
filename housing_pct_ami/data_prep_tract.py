...
#ROOTBEER = '/home/ubuntu/housing_equity/housing_pct_ami/' #production
ROOTBEER = '' #local
...
ami_raw = ami_raw[(ami_raw['CENSUS_QUERY'] == 'B19081_003E')]
...
df['housing_pct_ami_2013'] = df['MEDIAN_MONTHLY_HOUSING_COST_2013'] / df['ami_monthly_2013']
df['housing_pct_ami_2018'] = df['MEDIAN_MONTHLY_HOUSING_COST_2018'] / df['ami_monthly_2018']
...
df['housing_pct_ami_change'] = (df.housing_pct_ami_2018 - df.housing_pct_ami_2013)
...
df['housing_pct_ami_change'] = (df.housing_pct_ami_change - df.housing_pct_ami_change.mean())/df.housing_pct_ami_change.std()
...
df['housing_pct_ami_2013z'] = (df.housing_pct_ami_2013 - df.housing_pct_ami_2013.mean())/df.housing_pct_ami_2013.std()
...
df['housing_pct_ami_2018z'] = (df.housing_pct_ami_2018 - df.housing_pct_ami_2018.mean())/df.housing_pct_ami_2018.std()
...
housing_pct_ami = df[['GEOID','housing_pct_ami_change','housing_pct_ami_2013z','housing_pct_ami_2018z']]
gdf = gdf.merge(housing_pct_ami, how = 'inner', left_on = ['GEOID_a'], right_on = ['GEOID'])
gdf = gdf.rename(columns = {'housing_pct_ami_change':'housing_pct_ami_change_a'})
gdf = gdf.rename(columns = {'housing_pct_ami_2013z':'housing_pct_ami_2013z_a'})
gdf = gdf.rename(columns = {'housing_pct_ami_2018z':'housing_pct_ami_2018z_a'})
gdf = gdf[['GEOID_a','GEOID_b','distance','minority_pop_pct_change_a','minority_pop_pct_change_b','minority_pop_pct_2013z_a','minority_pop_pct_2013z_b','minority_pop_pct_2018z_a','minority_pop_pct_2018z_b','rent_25th_pctile_change_a','rent_25th_pctile_2013z_a','rent_25th_pctile_2018z_a','rent_25th_pctile_change_b','rent_25th_pctile_2013z_b','rent_25th_pctile_2018z_b','totpop_change_a','totpop_2013z_a','totpop_2018z_a','totpop_change_b','totpop_2013z_b','totpop_2018z_b','rent_pct_income_change_a','rent_pct_income_2013z_a','rent_pct_income_2018z_a','rent_pct_income_change_b','rent_pct_income_2013z_b','rent_pct_income_2018z_b','monthly_housing_cost_change_a','monthly_housing_cost_2013z_a','monthly_housing_cost_2018z_a','monthly_housing_cost_change_b','monthly_housing_cost_2013z_b','monthly_housing_cost_2018z_b','affordable_units_per_cap_change_a','affordable_units_per_cap_2013z_a','affordable_units_per_cap_2018z_a','affordable_units_per_cap_change_b','affordable_units_per_cap_2013z_b','affordable_units_per_cap_2018z_b','median_tenancy_change_a','median_tenancy_2013z_a','median_tenancy_2018z_a','median_tenancy_change_b','median_tenancy_2013z_b','median_tenancy_2018z_b','median_housing_age_change_a','median_housing_age_2013z_a','median_housing_age_2018z_a','median_housing_age_change_b','median_housing_age_2013z_b','median_housing_age_2018z_b','white_pop_pct_change_a','white_pop_pct_2013z_a','white_pop_pct_2018z_a','white_pop_pct_change_b','white_pop_pct_2013z_b','white_pop_pct_2018z_b','market_rate_units_per_cap_change_a','market_rate_units_per_cap_2013z_a','market_rate_units_per_cap_2018z_a','market_rate_units_per_cap_change_b','market_rate_units_per_cap_2013z_b','market_rate_units_per_cap_2018z_b','ami_monthly_change_a','ami_monthly_2013z_a','ami_monthly_2018z_a','ami_monthly_change_b','ami_monthly_2013z_b','ami_monthly_2018z_b','housing_pct_ami_change_a','housing_pct_ami_2013z_a','housing_pct_ami_2018z_a']]
gdf = gdf.merge(housing_pct_ami, how = 'inner', left_on = ['GEOID_b'], right_on = ['GEOID'])
gdf = gdf.rename(columns = {'housing_pct_ami_change':'housing_pct_ami_change_b'})
gdf = gdf.rename(columns = {'housing_pct_ami_2013z':'housing_pct_ami_2013z_b'})
gdf = gdf.rename(columns = {'housing_pct_ami_2018z':'housing_pct_ami_2018z_b'})
gdf = gdf[['GEOID_a','GEOID_b','distance','minority_pop_pct_change_a','minority_pop_pct_change_b','minority_pop_pct_2013z_a','minority_pop_pct_2013z_b','minority_pop_pct_2018z_a','minority_pop_pct_2018z_b','rent_25th_pctile_change_a','rent_25th_pctile_2013z_a','rent_25th_pctile_2018z_a','rent_25th_pctile_change_b','rent_25th_pctile_2013z_b','rent_25th_pctile_2018z_b','totpop_change_a','totpop_2013z_a','totpop_2018z_a','totpop_change_b','totpop_2013z_b','totpop_2018z_b','rent_pct_income_change_a','rent_pct_income_2013z_a','rent_pct_income_2018z_a','rent_pct_income_change_b','rent_pct_income_2013z_b','rent_pct_income_2018z_b','monthly_housing_cost_change_a','monthly_housing_cost_2013z_a','monthly_housing_cost_2018z_a','monthly_housing_cost_change_b','monthly_housing_cost_2013z_b','monthly_housing_cost_2018z_b','affordable_units_per_cap_change_a','affordable_units_per_cap_2013z_a','affordable_units_per_cap_2018z_a','affordable_units_per_cap_change_b','affordable_units_per_cap_2013z_b','affordable_units_per_cap_2018z_b','median_tenancy_change_a','median_tenancy_2013z_a','median_tenancy_2018z_a','median_tenancy_change_b','median_tenancy_2013z_b','median_tenancy_2018z_b','median_housing_age_change_a','median_housing_age_2013z_a','median_housing_age_2018z_a','median_housing_age_change_b','median_housing_age_2013z_b','median_housing_age_2018z_b','white_pop_pct_change_a','white_pop_pct_2013z_a','white_pop_pct_2018z_a','white_pop_pct_change_b','white_pop_pct_2013z_b','white_pop_pct_2018z_b','market_rate_units_per_cap_change_a','market_rate_units_per_cap_2013z_a','market_rate_units_per_cap_2018z_a','market_rate_units_per_cap_change_b','market_rate_units_per_cap_2013z_b','market_rate_units_per_cap_2018z_b','ami_monthly_change_a','ami_monthly_2013z_a','ami_monthly_2018z_a','ami_monthly_change_b','ami_monthly_2013z_b','ami_monthly_2018z_b','housing_pct_ami_change_a','housing_pct_ami_2013z_a','housing_pct_ami_2018z_a','housing_pct_ami_change_b','housing_pct_ami_2013z_b','housing_pct_ami_2018z_b']]
...
gdf['housing_pct_ami_delta'] = ((((1-omicron) * gdf.housing_pct_ami_change_a) + (omicron * gdf.housing_pct_ami_2013z_a)) - (((1-omicron) * gdf.housing_pct_ami_change_b) + (omicron * gdf.housing_pct_ami_2013z_b))).abs()
gdf['housing_pct_ami_delta'] = gdf['housing_pct_ami_delta'].fillna(0)
...
gdf['housing_pct_ami_change_delta_2013'] = ((gdf.housing_pct_ami_2013z_a) - (gdf.housing_pct_ami_2013z_b)).abs()
gdf['housing_pct_ami_change_delta_2013'] = gdf['housing_pct_ami_change_delta_2013'].fillna(0)
...
gdf['housing_pct_ami_change_delta_2018'] = ((gdf.housing_pct_ami_2018z_a) - (gdf.housing_pct_ami_2018z_b)).abs()
gdf['housing_pct_ami_change_delta_2018'] = gdf['housing_pct_ami_change_delta_2018'].fillna(0)
